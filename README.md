...
最後一步，即為特徵點的特徵描述。特徵點的方向的求法是需要對特徵點鄰域內的點的梯度方向進行直方圖統計，選取直方圖中比重最大的方向為特徵點的主方向，還可以選擇一個輔方向。在計算特徵向量時，需要對區域性影象進行沿主方向旋轉，然後再進鄰域內的梯度直方圖統計 原文網址：https://itw01.com/AHKEC6Z.html
